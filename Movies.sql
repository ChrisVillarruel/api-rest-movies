create table tbl_movie_category(
    ...
    category_desc varchar(250) default "Sin descripción",
...
create table tbl_classification(
    ...
    classification_desc varchar(250) default "Sin descripción",
...
create table tbl_movies(
    ...
    unique u_moview_name(name_movie),
...
alter table tbl_movies modify lauch_year int(4);
